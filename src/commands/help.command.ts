  ...
  },
  {
    ...
    body: () =>
      [
        ...
        '`/trieuphu` : 15 câu hỏi, tối đa 15.000 xu, ngày một lần',
  ...
  },
  {
    ...
    body: () =>
      [
        ...
        '`/cash xem` : ví tiền nạp 💵 cho các tính năng premium',
      ].join('\n'),
  },
  {
    key: 'life',
    ...
    body: () =>
      [
        '**Làm ăn phi pháp**',
        '`/trom nguoi` : móc ví người khác, 40% ăn 15% ví họ, trượt thì bóc lịch 30 phút',
        '`/nopphat` : chi 2.000 xu ra tù sớm, hoặc ngồi chờ hết hạn',
        '-# Đang ở tù thì đừng mơ chơi game hay tiêu tiền.',
        '',
        '**Mua sắm**',
        '`/shop` : xem hàng · `/mua mon` : xuống tiền · `/tuido` : kiểm kê · `/dungdo mon` : xài',
        '🛡️ Khiên chặn một lần bị trộm · 🍀 Bùa may mắn +10% tiền lời 1 giờ',
        '☕ Cà phê xóa cooldown làm việc · 🗝️ Chìa khóa vượt ngục · 📦 Hộp quà hên xui',
        '',
        '**Chuyện đôi lứa**',

...
export function buildCommentaryPrompt(players: CommentaryInput[]): string {
  ...
  return [
    ...
    'Với MỖI người, viết đúng MỘT câu nhận xét hóm hỉnh bằng tiếng Việt, tối đa 90 ký tự,',
    'dựa trên chi tiết đắt giá nhất trong số liệu, giọng trêu nhẹ nhàng, không xúc phạm,',
    'không gọi tên riêng, không dùng dấu gạch ngang dài, tối đa 1 emoji mỗi câu.',
